...
50 Negative Functional Tests – These tests evaluate cases where the system fails to correctly convert Singlish input into Sinhala output. The scenarios cover a wide range of informal language patterns, spelling variations, embedded English words, symbols, and real-world chat inputs.
